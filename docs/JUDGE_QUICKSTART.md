...
1. Select **Load Starter Workspace** at the top of the app.
...
4. Select **Reset Starter Workspace** to repeat the walkthrough; only fictional demo-linked records are restored.
